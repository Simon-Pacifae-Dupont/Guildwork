...
| `desk-demo.png`, `desk-demo.fr.png` | the no-code desk on the Lantern snapshot, English and French, rendered from `demo/desk/` and `fr/demo/desk/` — the same page in two languages: regenerate both, or neither |
